                                                    ...
                                                    <div class="row gy-4">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="full-name" name="name" placeholder="Class name">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="full-name">Sec Name</label>
                                                                <input type="text" class="form-control" id="full-name" name="sec_name" placeholder="Second name">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select js-select2" data-placeholder="Select multiple options" name="school_id" required>
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <select class="form-select js-select2" id="program_id" data-placeholder="Select multiple options" name="program_id" required>
                                                                        ...
                                                                        @foreach ($programs as $program)
                                                                            <option value="{{ $program->id }}">{{ $program->name . '/' . $program->course->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('program_id')
                                                                        <div class="text-danger">{{ $message }}</div>
